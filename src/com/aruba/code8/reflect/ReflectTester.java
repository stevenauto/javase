...
/**新生成的对象的属性是由传过来的对象object（customer）赋予的，
 * Object invokeTester = classType.newInstance();调用了不带参数的构造方法，跟objectCopy的一样
 * Object objectCopy = classType.getConstructor(new Class[] {}).newInstance(new Object[] {});
 * 	但是objectCopy可以带参数，newInstance不能带参数	
